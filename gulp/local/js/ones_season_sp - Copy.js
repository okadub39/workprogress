...
$(window).on('load resize', function(){
equalBoxHeight("#contents--induction .container--box__text a", 2);
equalBoxHeight("#search--festa__area .container--box__area a", 2);

equalBoxHeight("#imagetext--twocolum__twocolum .container--box__area a", 2);
equalBoxHeight("#search--event__area .container--area__lists a", 2);
});
