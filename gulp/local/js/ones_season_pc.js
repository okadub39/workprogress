...
equalBoxHeight("#new--information__photo .container--box__001", 3);
equalBoxHeight("#contents--article__induction .container--box__area a", 4);
equalBoxHeight("#contents--restaurant__guidance .container--box__area .accordion--spot", 2);
equalBoxHeight("#contents--feature__square .container--box__area a", 3);
equalBoxHeight("#contents--feature__3-2 .container--box__area a", 2);
equalBoxHeight("#imagetext--onecolum__fourcolum .container--box__area a", 4);
equalBoxHeight("#imagetext--onecolum__twocolum .container--box__area a", 2);
equalBoxHeight("#imagetext--twocolum__twocolum .container--box__area a", 2);
});
