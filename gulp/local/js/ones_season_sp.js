...
jQuery(document).ready(function($) {
	height_adjust($('#imagetext--twocolum__twocolum .container--box a'));
	height_adjust($('#contents--induction .container--box__text a'));
	height_adjust($('#search--festa__area .container--box__area a'));
	height_adjust($('#search--event__area .container--area__lists a'));
});
