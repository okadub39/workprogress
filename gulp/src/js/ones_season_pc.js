...
$(window).load(function() {
	$('.contents--component__001').each(function(i, box) {
		var maxHeight = 0;
...
$(window).load(function() {
	$('.contents--component__010').each(function(i, box) {
		var maxHeight = 0;
...
var tableSet002 = "<i class='arrow--position fas fa-angle-right' onclick='add()'></i></div><div id ='table'>";
//変数の中にHTML要素を格納する。
